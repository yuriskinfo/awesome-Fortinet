...
* https://support.fortinet.com/ticket/BugList.aspx Official Bug Tracker, available *only* to Fortinet Partners, good to check especially with new FortiOS versions if issue you are experiencing is a bug.
...
* https://blog.golle.org/  Emil Boklund blog, not Fortinet-only but includes.
* https://implicitdeny.info/ David Traill blog, System Engineer at Fortinet.
* https://blog.guenay.at/ Kevin Guenay blog, one of the most active members of r/fortinet, also hailed Member of the 2023 Year there.
...
* https://yurisk.info Yuri Slobodyanyuk (mine) blog on many things Fortinet-related.


== Video

* https://video.fortinet.com/ Video walkthroughs, What's New videos and more in the official Fortinet Video Library.
* https://www.youtube.com/@fortinetvideolibrary Fortinet video library on the Youtube. 
...
* https://www.youtube.com/@WilliamGregoire-q8g William Grégoire's brand new channel in French. 
