...
* https://www.cbtnuggets.com/it-training/fortinet CBT Nuggets, currently (2024) they have courses for Fortigate, FortiManager, FortiAnalyzer, Fortiswitch, and FortiAuthenticator. They are good for 1st time users/beginners. 
